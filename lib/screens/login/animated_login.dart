...
import 'login_components/src_shelf.dart';

export 'login_components/constants/enums/enums_shelf.dart';
export 'login_components/models/models_shelf.dart';
export 'login_components/providers/login_texts.dart';
export 'login_components/providers/login_view_theme.dart';

part 'login_components/widgets/form_part.dart';
part 'login_components/widgets/welcome_components.dart';
...
class LoginScreen extends StatefulWidget {
  ...
  @override
  State<LoginScreen> createState() => _AnimatedLoginState();
}

class _AnimatedLoginState extends State<LoginScreen> {
